...
/******/ ([
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        {
            var HOSTED_VIEWER_ORIGINS = ['null', 'http://127.0.0.1', 'https://imagery.geocento.com', 'https://eineo.geocento.com'];
        ...
        function webViewerInitialized() {
            ...
            if (true) { //!window.File || !window.FileReader || !window.FileList || !window.Blob) {
