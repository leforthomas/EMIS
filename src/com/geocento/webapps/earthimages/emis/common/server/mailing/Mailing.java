...
public class Mailing {
    ...
    static public void sendEmail(String template, String recipients, String subject, String message, String plainText, String bccRecipients) throws EIException {
        ...
        try {
            ...
            if(bccRecipients != null) {
                msg.setRecipients(Message.RecipientType.BCC,
                        InternetAddress.parse(bccRecipients, false));
            }
            ...
            throw new EIException("Error sending email");
        }
    }
