...
public class Configuration {
    ...
    static public enum APPLICATION_SETTINGS {
        // for init
        applicationName, serverType, emailFrom, emailHost, emailPort, emailIssmpts, emailAccount, emailPassword, emailTemplatesPath, requestRecipients, adminEmail, websiteUrl, supportEmail,
        // used in the application
        downloadMethodsPath,
        productDownloaderUrl, callBackUrlProductDownloader,
        productPublisherUrl, callBackUrlProductPublisher, callBackUrlProductPublisherWorkspace,
        baseOrdersFileDirectory, baseThumbnailsDirectory,
        localPublisher,
        planetAPIToken, baseTempFileDirectory, baseDocumentsDirectory, planetOrderV2, openexchangeapiperiodhours, openexchangeapiurl, productServiceWMSURL
    };
    ...
    static public void loadConfiguration() throws Exception {
        ...
        props.load(new FileReader(home + "/configurations/eineo.properties"));
    }
