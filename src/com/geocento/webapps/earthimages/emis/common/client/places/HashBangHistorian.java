 ...
 * in a "hashbang" format (� la Twitter).
 * 
...
public class HashBangHistorian extends CustomHistorian {
  ...
  protected native void addHistoryEventHandler() /*-{
    ...
    $wnd.onhashchange = $entry(function(e) {
      ...
      var currentUrl = that.@com.geocento.webapps.earthimages.emis.common.client.places.HashBangHistorian::currentUrl;
      ...
      if (hash !== currentUrl) {
        that.@com.geocento.webapps.earthimages.emis.common.client.places.CustomHistorian::onHistoryChange()();
        if (oldHandler) {
          oldHandler();
        }
      }
