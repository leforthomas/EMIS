...
public class AISignInViewImpl extends Composite implements AISignInView {

	private static AISignInViewUiBinder uiBinder = GWT
			.create(AISignInViewUiBinder.class);

	interface AISignInViewUiBinder extends UiBinder<Widget, AISignInViewImpl> {
	}
	...
	public AISignInViewImpl(ClientFactory clientFactory) {
